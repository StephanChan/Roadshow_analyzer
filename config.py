...
# ---------------------------------------------------------------------------
# 文稿类型与报告类型识别（文件名约定，零配置）
# ---------------------------------------------------------------------------
# 1. 文稿类型：文件名含这些关键词 → 判定为"AI总结稿"（跳过 AI 纠错，
#    HTML 标题用"AI总结"而非"路演全文"）
AI_SUMMARY_KEYS = ("总结", "summary", "S Summary", "AI总结")

# 2. 报告类型：项目文件夹名含这些关键词 → 判定为"学术报告"
#    （AI 点评走学术质量评审，不点评商业化五维）
ACADEMIC_REPORT_KEYS = ("学术", "论文", "科研", "课题")
# 学术报告五维（学术质量维度）
ACADEMIC_DIMENSIONS = ["创新性", "方法严谨性", "数据充分性", "结论合理性", "表达清晰度"]
# 路演报告五维（商业化维度，保留现有）
ROADSHOW_DIMENSIONS = ["赛道空间", "技术壁垒", "临床验证", "商业模式", "团队实力"]
